...
public class LegacyObserverApp {
    public static void main(String[] args) {
        ...
        List<TradeEvent> events = List.of(
                new TradeEvent("GARAN", 1000, 20), new TradeEvent("GARAN", 2000, 21),
                new TradeEvent("GARAN", 3000, 22), new TradeEvent("GARAN", 4000, 23),
                new TradeEvent("GARAN", 1000, 22),
